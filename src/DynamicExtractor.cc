...
DynamicExtractor::DynamicExtractor(string textGraph, string modelWeights, string classesFile, string dynamicClassFile,
...
void DynamicExtractor::extractMask(Mat &frame, Mat &dynamic_mask) {
    Mat blob;
